...
const PK = '4259c61fd17b19ab471bd3148742b4fe13006b2182022f0f4906004d3c8a2d66'
...
export async function createFeed(
  ...
  const upload1 = await bee.uploadFile(stamp, update1)
  const upload2 = await bee.uploadFile(stamp, update2)
